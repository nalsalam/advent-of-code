...
Similar to move_9000(), does not need the `n` parameter, but requires the `move_1` data. I created this because I thought I could use it with `Reduce` but I did not figure that out.
